...
import model.Sheet423CorePDM;
import model.Sheet423PersonalPDM;
...
public class Sheet423Filler {
    ...
    private static void insert(Sheet sheet423
        ...
        int index = sheet423.getLastRowNum() + 1;
    ...
    private static void insertNumeric(Row row
        ...
        if(destination.equals(FileDestination.Personal)){
            ...
            data.add(0F);
            data.add(new Float(sheet423CorePDM.getTotalSpace5()));
            data.add(new Float(sheet423CorePDM.getRemainSpace5()));
            data.add(sheet423CorePDM.getUsage5());
    ...
    private static void insertASMName(Row row, Sheet423PersonalPDM sheet423PDM
        ...
        if(destination.equals(FileDestination.Core)){
            ...
            Cell cellASM5 = ExcelUtils.getCell(row, ExcelConfig.Sheet423PersonalStart
                    + 3*ExcelConfig.Sheet423DataDistance);
            cellASM5.setCellStyle(cellStyle);
            cellASM5.setCellValue(sheet423CorePDM.getAsmName5());
        }
    }
